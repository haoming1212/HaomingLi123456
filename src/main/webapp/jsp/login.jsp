    ...
    <div id="app">
        <div id="form-div">
            ...
            <div class="mb-3 row" style="text-align: center">
                <div class="col">
                    <button type="button" class="btn btn-primary mb-3" onclick="login()">Login</button>
                </div>

                <div class="col">
                    <button type="button" class="btn btn-info mb-3" onclick="toRegister()">To Register</button>
                </div>
            </div>
        </div>
    </div>
